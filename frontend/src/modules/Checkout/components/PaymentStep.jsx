...
import "@/app/styles/PaymentStep.css";
import { debounce } from "lodash";
import { useAuth } from "@/modules/User/auth/context/AuthProvider"; // NEW
...
export default function PaymentStep() {
  ...
  const validateCod = useMemo(() => debounce(async () => {
    ...
    setCodLoading(true);
    try {
      const res = await api.post("/payment/cod-validate", { items: itemsPayload });
