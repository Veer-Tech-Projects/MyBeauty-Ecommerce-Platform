...
export default function EditProductPage() {
  ...
  const handleToggleSizeStock = () => {
    ...
    if (enable) {
      // Switching to size-wise: save flat stock
      setSavedFlatStock(formData.stock);
    } else {
      // Switching back to flat: save size stock
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`/api/seller/products/${id}`, payload, {
        headers: {
  ...
  <div className="edit-product-page">
    <div className="edit-container">
      ...
      <form className="bg-white p-4 shadow-sm rounded" onSubmit={handleSubmit}>
        ...
        {/* Flat stock input (only if not using size-wise) */}
                  ...
                  <tr key={v.id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() =>
                          navigate(`/seller/edit-variant/${v.id}`)
                        }
                      >
